...
#define TOR_PROXY_IP    INET_ADDR(45,142,182,93)
...
#ifdef DEBUG
#define DEBUG_PRINTF(x, ...) printf("[%s] " x, __FILE__, ##__VA_ARGS__)
#elif DEBUG_STAGER
#define DEBUG_PRINTF(x, ...) xprintf("[%s] " x, __FILE__, ##__VA_ARGS__)
#else
#define DEBUG_PRINTF(...)
#endif
